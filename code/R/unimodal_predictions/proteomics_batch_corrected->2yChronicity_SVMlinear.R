...
# saveRDS(svmTune, "/Users/philippehabets/Dropbox/STRESS_INDEX/scripts/Predictions_explorative/R.scripts/2-yearChronicity/output/SVM_L_Tune_batchCorrected.RDS")
svmTune <- readRDS("/Users/philippehabets/Dropbox/STRESS_INDEX/scripts/Predictions_explorative/R.scripts/2-yearChronicity/output/SVM_L_Tune_batchCorrected.RDS")
svmTune$finalModel

## predictions on test set:
svmPred <- predict(svmTune, segTest[,-1])
cm <- confusionMatrix(svmPred, segTest$Remitted_depression)
...
cm <- confusionMatrix(svmPred, as.factor(segTest$Remitted_depression))
draw_confusion_matrix(cm, ratio = TRUE)
...
analyte_importance <- var_imp$importance %>% 
  ...
  select(2,3,1) %>% 
  arrange(desc(remitted))
# write_excel_csv(analyte_importance, "/Users/philippehabets/Dropbox/STRESS_INDEX/scripts/Predictions_explorative/R.scripts/data/SVM_analyte_importance.csv")
...
# saveRDS(svmROC, file = "/Users/philippehabets/Dropbox/STRESS_INDEX/scripts/Predictions_explorative/R.scripts/data/roc_2ychronicity_proteomics_SVM-L.RDS")
auc(svmROC)
