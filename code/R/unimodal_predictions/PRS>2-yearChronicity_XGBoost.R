...
whole_set <- inner_join(w3Chronicity, prs, by = c("pident" = "pident"))
whole_set$Remitted_depression <- revalue(whole_set$Remitted_depression, c("remitted"="remitted", "non-remitted"="not_remitted")) 
table(whole_set$Remitted_depression) # 361 remitted vs 340 non-remitted
...
# saveRDS(elnet, "/Users/philippehabets/Dropbox/STRESS_INDEX/scripts/Predictions_explorative/R.scripts/2-yearChronicity/output/elTune_29PRS.RDS")
elnet <- readRDS("/Users/philippehabets/Dropbox/STRESS_INDEX/scripts/Predictions_explorative/R.scripts/2-yearChronicity/output/elTune_29PRS.RDS")
...
# saveRDS(XGbTune, "/Users/philippehabets/Dropbox/STRESS_INDEX/scripts/Predictions_explorative/R.scripts/2-yearChronicity/output/XGbTune_29PRS.RDS")
XGbTune <- readRDS("/Users/philippehabets/Dropbox/STRESS_INDEX/scripts/Predictions_explorative/R.scripts/2-yearChronicity/output/XGbTune_29PRS.RDS")
...
plot <- ggplot(plot_df, aes(specificity, sensitivity)) +
  ...
  geom_text(data = subset(plot_df, specificity==cutoff$specificity & sensitivity ==cutoff$sensitivity), 
            aes(label = paste0("balanced \naccuracy = ", format(round(cm$byClass[11],3), nsmall=2)), 
                hjust = cutoff$specificity-0.9, 
                vjust = cutoff$sensitivity+0.9), 
            colour = "black", 
            size=6) +
  coord_fixed(ratio = 1, xlim = NULL, ylim = NULL, expand = TRUE, clip = "on") +
  theme_classic() +
...
# ggsave("/Users/philippehabets/Dropbox/STRESS_INDEX/manuscripts/prediction_2ychronicity/Figures/output/auc_PRS.pdf",
#        plot,
