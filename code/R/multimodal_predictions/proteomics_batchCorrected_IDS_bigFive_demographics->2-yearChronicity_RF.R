...
rfTune <- train(x = segTrain[,-1],
                 ...
                 preProcess = c("medianImpute"), # will only be performed on clinical variables as proteomic variables are already imputed, center + scale for rf
                 verbose = TRUE)

toc_hour()

# saveRDS(rfTune, "/Users/philippehabets/Dropbox/STRESS_INDEX/scripts/Predictions_explorative/R.scripts/data/rfTune_prot_clin.RDS")
rfTune <- readRDS("/Users/philippehabets/Dropbox/STRESS_INDEX/scripts/Predictions_explorative/R.scripts/data/rfTune_prot_clin.RDS")
...
# saveRDS(rfROC, file = "/Users/philippehabets/Dropbox/STRESS_INDEX/scripts/Predictions_explorative/R.scripts/data/roc_2ychronicity_prot_clin_RF.RDS")
auc(rfROC)
ci.auc(rfROC)
...
analyte_importance <- var_imp$importance %>% 
  ...
  select(2,3,1)
# write_excel_csv(analyte_importance, "/Users/philippehabets/Dropbox/STRESS_INDEX/scripts/Predictions_explorative/R.scripts/data/analyte_importance_RF-Gain.csv")
